...
```
 ...
 ## Core edge question
  ...
  The framing question for evaluating whether the strategy has edge:
  "When I disagree with the market and act on it, am I right more than I'm
  wrong, net of the spread I pay or collect?"
  - Brier measures forecast accuracy in a vacuum; it is NOT edge.
  - Edge = accuracy *relative to the price I transact at*, monetized
    through fills (spread capture + trading the right side).
  - A worse Brier with positive P&L is expected for a market maker — the
    money comes from microstructure and trade selection, not out-
